...
object MailContentFactory {
    ...
    @Throws(UnsupportedMailContentException::class)
    fun from(order: Order): MailContentStrategy = when (order.status) {
        ...
        OrderStatus.PENDING -> throw UnsupportedMailContentException("Pending orders do not have a mail content strategy")
    }
